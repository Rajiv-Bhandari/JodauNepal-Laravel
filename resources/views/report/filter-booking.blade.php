                                    ...
                                    <form type="GET" action="#">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="assetSelect" name="report" value="report">
                                                    <option value="">Select Status</option>
                                               
                                                </select>
                                                @if ($errors->has('asset'))
                                                <x-validation-errors><div class="form-group col-3 py-2">
                                                        {{ $errors->first('asset') }}
                                                    </x-validation-errors>
                                                @endif
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control px-2" name="status" >
